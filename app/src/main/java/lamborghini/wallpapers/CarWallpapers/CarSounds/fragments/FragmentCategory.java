...
import lamborghini.wallpapers.CarWallpapers.CarSounds.activities.ActivityVideoByCategory;
import lamborghini.wallpapers.CarWallpapers.CarSounds.adapters.AdapterCategory;
...
public class FragmentCategory extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        adapterCategory = new AdapterCategory(getActivity(), new ArrayList<CategoryVideo>());
        recyclerView.setAdapter(adapterCategory);

        // on item list clicked
        adapterCategory.setOnItemClickListener(new AdapterCategory.OnItemClickListener() {
            @Override
            public void onItemClick(View v, CategoryVideo obj, int position) {
    ...
    private void displayApiResult(final List<CategoryVideo> categories) {
    ...
    private void requestAction() {
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                new MyTask().execute("https://storage.googleapis.com/mythical-ace-4987/yt-project/video-category.json");
            }
        }, Constant.DELAY_TIME);
    }
    ...
    public void setJsonToObj(String tmpMainJson){
        ...
        if (tmpMainJson == null){
            ...
            if (tmpMainJson.length() <= 0){
                ...
                List<CategoryVideo> videoCategoryList = new ArrayList<>();
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        CategoryVideo tmpVideoCategory = new CategoryVideo();
